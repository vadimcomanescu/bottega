...
3. Interviews. When brainstorming leaves unknowns, have the model interview you round by round, with context about your problem to guide its questions, prioritizing the ones whose answer would change the architecture.
