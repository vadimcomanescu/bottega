...
Superseded in part: the two-harness method ended when Codex was dropped as an orchestrator (`0019-claude-code-orchestrates.md`); a run is orchestrated from Claude Code alone, and GPT models run as workers.
