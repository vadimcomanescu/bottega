...
Superseded in part: the release clause below moved to the launch in `0028-the-launch-decides-the-release.md`, where the request says whether the PR lands on green or holds and the run arms the repository's auto-merge. Verification is untouched.
