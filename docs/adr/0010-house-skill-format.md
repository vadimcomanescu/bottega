...
The directory's "vendored" freeze was removed in the same change: it named no upstream and carried no license or sync contract (unlike `skills/autoreview/`), and it kept the house doctrine out of the one file every skill edit reads.
