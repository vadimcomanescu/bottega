...
The rule: a capability the diff adopts ships with its working verification (the mechanism ran, with evidence), or with a tracking issue filed in the same delivery. With neither, every path that names the capability depends on something that has never been made to work.
