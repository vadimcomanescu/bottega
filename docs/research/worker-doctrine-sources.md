...
| --- | --- | --- |
| `skills/deliver` | Explicit user entry, executed by Fable; composes every phase | Keep as the orchestration skill. It owns gates, routing, decisions, and phase transitions, not worker programming method. |
...
| `skills/deliver/references/codex-dispatch.md` | Codex launch and resume mechanics used by run | Keep as a reference. It is supporting runtime detail, not a user or model-invoked capability. |
