...
| `skills/run/SKILL.md` | Maestro doctrine — the entry point (`/bottega:run`), gates, architecture authority, routing |
...
| `skills/implementing`, `skills/reviewing`, `skills/qa`, `skills/storyboarding` | Self-contained actor methodology (nothing loaded from any host pack); storyboarding is the render seat — admissible frames, real captures only |
