...
Hold every skill to one virtue: **predictability**, the agent taking the same _process_ every run, not producing the same output. Every lever below serves it.
...
- [ ] The house format holds: frontmatter universal, H1 and opening sentence, pointer style, one of the two body shapes.
