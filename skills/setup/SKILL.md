...
- Migrations, formats per `bottega:architect`: real domain terms move to the vocabulary home and qualifying decisions to the ADR home, every reference updated in the same change. Existing formats win. When source and target both hold material, bring the merge to me before writing.
