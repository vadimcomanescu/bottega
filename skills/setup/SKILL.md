...
For every gap between the found state and the shape, show me the exact edit that closes it. Content moves, and you invent nothing: an empty glossary, ADR scaffold, or owner doc is nothing to write.
