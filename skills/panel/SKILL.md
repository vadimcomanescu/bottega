...
Another family's CLI installed on the machine takes a further seat under the same task, read-only with its own web search. Inside a run, the routing table in `skills/deliver/SKILL.md` governs the seat models.
