...
1. Take the signed scenarios (`features/*.feature`) as your script — the dossier may narrow it to the scenarios a re-drive affects. Expand every Scenario Outline row.
