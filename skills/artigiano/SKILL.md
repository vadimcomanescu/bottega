---
name: artigiano
description: Take a task, bug, or bead to a reviewed, evidence-backed PR ready to merge. Use artigiano, or when the user asks bottega for work in their own words. Never use proactively. A run costs hours of autonomous agent work.
