...
Write a self-contained HTML file to `<tmpdir>/architecture-review-<timestamp>.html` in the OS temp directory, so nothing lands in the repo and each run gets a fresh file. Open it for the user and tell them the absolute path.
