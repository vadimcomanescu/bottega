...
**Rounds.** Each round runs the review gate per `bottega:review` with its PR-only inputs, over the diff the reviewed marker leaves for it. Unresolved threads enter round 1 whatever the marker says.
